...
class InventoryPage extends BasePage {
    ...
    inventoryItemDescription = (itemName: string) => cy.get('[data-test="inventory-item-name"]').contains(itemName).closest('div[data-test="inventory-item-desc"]');
    inventoryItemPrice = (itemName: string) => cy.get('[data-test="inventory-item-name"]').contains(itemName).closest('div[data-test="inventory-item-price"]');
    addToCartButton = (itemName: string) => cy.get('[data-test="inventory-item-name"]').contains(itemName).closest('div[data-test*="add-to-cart-sauce-labs-"]');
    sideMenu = {
