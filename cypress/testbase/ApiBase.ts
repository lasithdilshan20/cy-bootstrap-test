 ...
 */
Cypress.Commands.add('sendApiRequest', (endpoint: string, method: string, token: string, expectedStatus: number, body: any = undefined) => {
  cy.api({
    method: method,
    url: endpoint,
...
Cypress.Commands.add(
  'sendApiRequestDef',
  (endpoint: string, method: string, token: string, expectedStatus: number | number[], body: any = undefined) => {
    cy.request({
      method: method,
      url: endpoint,
      failOnStatusCode: false,
...
Cypress.Commands.add('sendApiRequestWithAttachment', (endpoint: string, method: string, token: string, expectedStatus: number, resourceId: string, filePath: string) => {
...
Cypress.Commands.add(
  ...
  (endpoint: string, method: string, token: string, expectedStatus: number, params: Record<string, any> = {}, body: any = undefined) => {
