...
describe('Login Page Test Suite', () => {
    ...
    it('should display the login form and the validation messages', {tags: ['@smoke', '@login-page']}, () => {
    ...
    it('should display proper error message for locked out user', {tags: ['@smoke', '@login-page']}, () => {
        ...
        LoginPage.loginButton().click();
        LoginPage.errorLabel("Epic sadface: Sorry, this user has been locked out.").should('be.visible');
    });

    it('should login successfully with valid credentials', {tags: ['@smoke', '@login-page']}, () => {
