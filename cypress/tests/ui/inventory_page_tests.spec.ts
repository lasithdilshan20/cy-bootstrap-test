...
describe('Inventory Page Test Suite', () => {
    ...
    it('should display products in the inventory page', {tags: ['@smoke', '@inventory-page']}, () => {
    ...
    it('should display hamburger menu button and side menu buttons', {tags: ['@smoke', '@inventory-page']}, () => {
    ...
    it('should display filter options', {tags: ['@smoke', '@inventory-page']}, () => {
        const filterOptions = ['Name (A to Z)', 'Name (Z to A)', 'Price (low to high)', 'Price (high to low)'];
        ...
        InventoryPage.inventoryItems().first().within(() => {
            InventoryPage.inventoryItemNameLabel().invoke('text').then((lowPriceItemName) => {
        ...
        InventoryPage.inventoryItems().first().within(() => {
            InventoryPage.inventoryItemNameLabel().invoke('text').then((highPriceItemName) => {
    ...
    it('should adhere to WCAG 2.1 A, AA, Section 508 & best practice standards', {tags: ['@inventory-page', '@a11y']}, () => {
        cy.injectAxe();
